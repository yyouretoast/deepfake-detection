...
[![pytest](https://img.shields.io/badge/pytest-56%2F56%20Passing-2EA44F?style=flat&logo=pytest&logoColor=white)](https://docs.pytest.org/)
...
├── tests/                         # 56/56 passing unit tests
└── README.md
```
