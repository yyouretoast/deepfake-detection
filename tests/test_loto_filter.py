...
def test_matches_holdout_domain_pair_ranges() -> None:
    ...
    assert matches_holdout_domain("fake/650_655/frame_001.webp", "neuraltextures") is True
    ...
    assert matches_holdout_domain("fake/250_255/frame_001.webp", "face2face") is True
    assert matches_holdout_domain("fake/250_255/frame_001.webp", "faceswap") is False
